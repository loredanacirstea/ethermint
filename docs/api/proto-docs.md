...
- [ethermint/evm/v1/tx.proto](#ethermint/evm/v1/tx.proto)
    ...
    - [MsgEthereumIcaTx](#ethermint.evm.v1.MsgEthereumIcaTx)
...
- [ethermint/intertx/v1/query.proto](#ethermint/intertx/v1/query.proto)
    - [QueryInterchainAccountFromAddressRequest](#intertx.QueryInterchainAccountFromAddressRequest)
    - [QueryInterchainAccountFromAddressResponse](#intertx.QueryInterchainAccountFromAddressResponse)
...
<a name="ethermint.evm.v1.MsgEthereumIcaTx"></a>

### MsgEthereumIcaTx
MsgEthereumIcaTx same as MsgEthereumTx.
...
<a name="intertx.QueryInterchainAccountFromAddressRequest"></a>
...
<a name="intertx.QueryInterchainAccountFromAddressResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `InterchainAccountFromAddress` | [QueryInterchainAccountFromAddressRequest](#intertx.QueryInterchainAccountFromAddressRequest) | [QueryInterchainAccountFromAddressResponse](#intertx.QueryInterchainAccountFromAddressResponse) | QueryInterchainAccountFromAddress returns the interchain account for given owner address on a given connection pair | |
