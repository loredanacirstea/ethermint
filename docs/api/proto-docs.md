...
- [ethermint/intertx/v1/account.proto](#ethermint/intertx/v1/account.proto)
    - [AbstractAccount](#ethermint.intertx.v1.AbstractAccount)
  
- [ethermint/intertx/v1/query.proto](#ethermint/intertx/v1/query.proto)
    - [QueryAbstractAccountAddressFromInterchainAccountAddressRequest](#ethermint.intertx.v1.QueryAbstractAccountAddressFromInterchainAccountAddressRequest)
    - [QueryAbstractAccountAddressFromInterchainAccountAddressResponse](#ethermint.intertx.v1.QueryAbstractAccountAddressFromInterchainAccountAddressResponse)
    - [QueryInterchainAccountFromAddressRequest](#ethermint.intertx.v1.QueryInterchainAccountFromAddressRequest)
    - [QueryInterchainAccountFromAddressResponse](#ethermint.intertx.v1.QueryInterchainAccountFromAddressResponse)
  
    - [Query](#ethermint.intertx.v1.Query)
  
- [ethermint/intertx/v1/tx.proto](#ethermint/intertx/v1/tx.proto)
    - [MsgForwardEthereumTx](#ethermint.intertx.v1.MsgForwardEthereumTx)
    - [MsgRegisterAbstractAccount](#ethermint.intertx.v1.MsgRegisterAbstractAccount)
...
<a name="ethermint/intertx/v1/account.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## ethermint/intertx/v1/account.proto
...
<a name="ethermint/intertx/v1/query.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## ethermint/intertx/v1/query.proto



<a name="ethermint.intertx.v1.QueryAbstractAccountAddressFromInterchainAccountAddressRequest"></a>

### QueryAbstractAccountAddressFromInterchainAccountAddressRequest
...
<a name="ethermint.intertx.v1.QueryAbstractAccountAddressFromInterchainAccountAddressResponse"></a>

### QueryAbstractAccountAddressFromInterchainAccountAddressResponse
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `abstract_account_address` | [string](#string) |  |  |
...
<a name="ethermint.intertx.v1.QueryInterchainAccountFromAddressRequest"></a>
...
<a name="ethermint.intertx.v1.QueryInterchainAccountFromAddressResponse"></a>
...
<a name="ethermint.intertx.v1.Query"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `InterchainAccountFromAddress` | [QueryInterchainAccountFromAddressRequest](#ethermint.intertx.v1.QueryInterchainAccountFromAddressRequest) | [QueryInterchainAccountFromAddressResponse](#ethermint.intertx.v1.QueryInterchainAccountFromAddressResponse) | QueryInterchainAccountFromAddress returns the interchain account for given owner address on a given connection pair | |
| `AbstractAccountAddressFromInterchainAccountAddress` | [QueryAbstractAccountAddressFromInterchainAccountAddressRequest](#ethermint.intertx.v1.QueryAbstractAccountAddressFromInterchainAccountAddressRequest) | [QueryAbstractAccountAddressFromInterchainAccountAddressResponse](#ethermint.intertx.v1.QueryAbstractAccountAddressFromInterchainAccountAddressResponse) | QueryAbstractAccountFromAddress returns the abstract account for given owner address | |

 <!-- end services -->



<a name="ethermint/intertx/v1/tx.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## ethermint/intertx/v1/tx.proto



<a name="ethermint.intertx.v1.MsgForwardEthereumTx"></a>

### MsgForwardEthereumTx
MsgForwardEthereumTx defines the payload for Msg/SubmitEthereumTx
...
<a name="ethermint.intertx.v1.MsgRegisterAbstractAccount"></a>

### MsgRegisterAbstractAccount
MsgRegisterAbstractAccount defines the payload for Msg/RegisterAbstractAccount
...
<a name="ethermint.intertx.v1.MsgRegisterAccount"></a>
...
<a name="ethermint.intertx.v1.MsgRegisterAccountResponse"></a>
...
<a name="ethermint.intertx.v1.MsgSubmitTxResponse"></a>
...
<a name="ethermint.intertx.v1.Msg"></a>
