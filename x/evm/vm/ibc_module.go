...
func (im IBCModule) OnChanOpenInit(
	...
	fmt.Println("---OnChanOpenInit---", order, portID, channelID, chanCap, version, counterparty)
...
func (im IBCModule) OnChanOpenTry(
	...
	fmt.Println("---OnChanOpenTry---", order, portID, channelID, chanCap, counterpartyVersion, counterparty)
...
func (im IBCModule) OnRecvPacket(
	...
	fmt.Println("---OnRecvPacket---", packet)
...
func (im IBCModule) OnAcknowledgementPacket(
	...
	fmt.Println("---OnAcknowledgementPacket---", packet)
