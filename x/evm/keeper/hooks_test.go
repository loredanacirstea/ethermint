...
func (dh *LogRecordHook) PostTxProcessing(ctx sdk.Context, from common.Address, to *common.Address, receipt *ethtypes.Receipt, cfg *types.EVMConfig) error {
...
func (dh FailureHook) PostTxProcessing(ctx sdk.Context, from common.Address, to *common.Address, receipt *ethtypes.Receipt, cfg *types.EVMConfig) error {
...
func (suite *KeeperTestSuite) TestEvmHooks() {
	...
	for _, tc := range testCases {
		...
		cfg, _ := k.EVMConfig(ctx)
		result := k.PostTxProcessing(ctx, common.Address{}, nil, receipt, cfg)
